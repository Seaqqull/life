...
// Life.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLifeApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CLifeApp::OnAppAbout)
...
CLifeApp::CLifeApp()
{
	...
	SetAppID(_T("Life.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CLifeApp

CLifeApp theApp;


// инициализация CLifeApp
...
// обработчики сообщений CLifeApp
